...
class MyTestCase(unittest.TestCase):
    ...
    def test_l_cmd_path_file(self):
        ...
        self.assertTrue(output == "-rw-r--r-- 1622 Nov 17 12:05 ./parser/parser.go")

    def test_l_r(self):
        output = check_output(["python", "-m", "pyls", "-l", "-r"], text=True).strip()
        self.assertTrue(output == "-rw-r--r-- 4096 Nov 14 14:57 token\n"
    ...
    def test_l_r_t(self):
        ...
        self.assertTrue(output == "drwxr-xr-x 4096 Nov 17 12:51 parser\n"
                                  "-rw-r--r-- 4096 Nov 14 15:58 ast\n"
                                  "drwxr-xr-x 4096 Nov 14 15:21 lexer\n"
    ...
    def test_filter_dir(self):
        ...
        self.assertTrue(output == "-rw-r--r-- 4096 Nov 14 15:58 ast\n"
                                  "drwxr-xr-x 4096 Nov 14 15:21 lexer\n"
                                  "drwxr-xr-x 4096 Nov 17 12:51 parser\n"
                                  "-rw-r--r-- 4096 Nov 14 14:57 token")
    ...
    def test_filter_file(self):
        ...
        self.assertTrue(output == "drwxr-xr-x 1071 Nov 14 11:27 LICENSE\n"
                                  "drwxr-xr-x 83 Nov 14 11:27 README.md\n"
                                  "drwxr-xr-x 60 Nov 14 13:51 go.mod\n"
                                  "-rw-r--r-- 74 Nov 14 13:57 main.go")
